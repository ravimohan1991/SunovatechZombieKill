...
#include "SunovatechZombieKillOffroadCar.h"
#include "SunovatechZombieKillOffroadWheelFront.h"
#include "SunovatechZombieKillOffroadWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"
#include "GameFramework/SpringArmComponent.h"

ASunovatechZombieKillOffroadCar::ASunovatechZombieKillOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = USunovatechZombieKillOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = USunovatechZombieKillOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = USunovatechZombieKillOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = USunovatechZombieKillOffroadWheelRear::StaticClass();
